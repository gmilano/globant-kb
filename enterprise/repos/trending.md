...
|--------|----------|-------|-----------------------|
| [openclaw-org/openclaw](https://github.com/openclaw-org/openclaw) | MIT | 210k+ | **BREAKOUT 2026**: repo de más rápido crecimiento en historia de GitHub. De 9k a 210k+ ★. Agente multi-canal. Sam Altman endorsement. |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | Apache-2.0 | 80k+ | **NUEVO Apr 2026**: CLI agentic Google. ReAct, MCP nativo, 1M context. 80k+ ★ en pocas semanas. |
| [microsoft/agent-framework](https://github.com/microsoft/agent-framework) | MIT | 18k | **BUILD 2026**: CodeAct (Hyperlight micro-VM), Hosted Agents GA (Jul 2026), Agent Harness. MAF = estándar .NET enterprise. |
| [langgenius/dify](https://github.com/langgenius/dify) | Apache-2.0 | 144k | $30M raised, 144k ★ (Jul 2026, creciendo desde 138k Apr). MCP nativo, HITL. El visual builder más adoptado enterprise. |
| [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | MIT | 110k+ | LangGraph v1.1 Jun 2026: DeltaChannel, streaming v2, per-node timeouts. 34.5M descargas/mes. Production líder. |
...
| [OpenHands/OpenHands](https://github.com/OpenHands/OpenHands) | MIT | 70k+ | 72% SWE-bench Jun 2026. Enterprise Control Plane GA May 2026. Software SDK lanzado. Coding agents en producción enterprise. |
...
| [open-metadata/OpenMetadata](https://github.com/open-metadata/OpenMetadata) | Apache-2.0 | 8k+ | MCP server integrado v1.5+. EU AI Act compliance tooling. 3000+ enterprise deploys. |
| [twentyhq/twenty](https://github.com/twentyhq/twenty) | AGPL-3.0 | 45.5k | CRM moderno open-source. MCP server nativo en Cloud. Y Combinator backed. |

## Señales de Mercado Esta Semana

- **Microsoft BUILD 2026 (Jun)**: CodeAct en Hyperlight micro-VMs + Hosted Agents GA (Jul 2026)
- **Google Gemini CLI (Apr 2026)**: 80k+ ★, Apache-2.0, CLI agentic open-source
- **OpenClaw 210k+ ★**: repo de crecimiento más rápido en historia de GitHub
- **Agentic AI ROI 2026**: 171% ROI promedio; solo 41% cruzan break-even en 12 meses
