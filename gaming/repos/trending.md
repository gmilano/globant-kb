...
> Señales automáticas del pipeline + análisis manual. Última actualización: 2026-07-11

## 🆕 Nuevo en julio 2026

| Repo | Licencia | Descripción | Stars | Señal |
|------|----------|-------------|-------|-------|
| **Carbon Engine (EVE Online)** | MIT | Fenris Creations open-sourceo el engine de producción de EVE Online en julio 2026. Engine AAA MIT — rarísimo. AI tooling comunitario esperado Q3 2026. | — | Lanzado julio 2026; momentum creciendo |
| [lmgame-org/GamingAgent](https://github.com/lmgame-org/GamingAgent) | MIT | ICLR 2026. Benchmark canónico para LLMs en game loops. 6 juegos reales (Tetris, Sokoban, 2048, SMB, Ace Attorney). arXiv:2505.15146. | ~950 | Aceptado ICLR 2026; citado en GDC 2026 |
...
## Señales adicionales GDC 2026 a seguir

- **Unity MCP Plugin**: 268 herramientas para controlar el Editor Unity desde Claude/Cursor. AI agents creando scenes, GameObjects, builds. Libre y open source.
- **Microsoft WHAMM**: modelo de generación visual de gameplay en tiempo real. Posible open-source release.
- **Roblox AI tools expansion**: tras Dev Conference 2025, expansión de herramientas AI para creadores.
- **NVIDIA ACE on-device**: TTS on-device en GDC 2026 — 50+ juegos; elimina latencia cloud para NPC.
