...
| Repo | Licencia | Descripción | Stars | Señal |
|------|----------|-------------|-------|-------|
| [etched-ai/open-oasis](https://github.com/etched-ai/open-oasis) | MIT | Oasis 500M weights + inference. Primer Minecraft-like generado por AI frame-a-frame. Decart + Etched, oct 2024. | ~14k | Explosión viral oct 2024, nueva categoría |
| [eloialonso/diamond](https://github.com/eloialonso/diamond) | MIT | DIAMOND: RL agent en diffusion world model. NeurIPS 2024 Spotlight. CS:GO demo interactivo. | ~2k | Paper líder del área, referencia académica |
| [dweam-team/awesome-world-model-games](https://github.com/dweam-team/awesome-world-model-games) | MIT | Curated list of all playable world model games. Tracker del ecosistema emergente. | — | Repo de referencia para el ecosistema |
