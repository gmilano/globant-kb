# 📈 Repos trending — Education (semana 2026-07-12)

> Repos con crecimiento rápido, nuevas releases, o impulso en HN / r/learnmachinelearning / GitHub Trending.

| Nombre | Licencia | Descripción | Stars |
|--------|----------|-------------|-------|
| [HKUDS/DeepTutor](https://github.com/HKUDS/DeepTutor) | Apache-2.0 | Agent-native learning workspace: Chat, Quiz, Research, Visualize, Solve, Mastery Path — multi-engine RAG + memoria 3 capas | ~28k |
| [plastic-labs/tutor-gpt](https://github.com/plastic-labs/tutor-gpt) | GPL-3.0 | AI tutor con Theory-of-Mind reasoning; Honcho memory layer; TypeScript | ~904 |
...
| [alfredang/ai4kids](https://github.com/alfredang/ai4kids) | MIT | AI Kids Academy (4–16 años): storytelling gamificado, coding, game-dev, fonética, booking con PayNow. Next.js 16 + Claude | ~120 |
