...
**Stack**:
- [`OpenContracts (cite)`](https://github.com/Open-Source-Legal/OpenContracts) — DMS con MCP server, annotation graph, GraphQL API (MIT)
...
Contrato M&A complejo ingresa
    → lavern: asigna a 10-15 agentes especializados (IP, tax, employment, IP, antitrust, etc.)
...
**Stack**:
- [`Docassemble`](https://github.com/jhpyle/docassemble) — guided interview + document assembly (MIT)
...
**Stack**:
- [`CourtListener`](https://github.com/freelawproject/courtlistener) — 7M+ opiniones US + API (Apache-2.0)
...
*Ver: `agents/top.md` para el inventario completo de agentes, `repos/foundations.md` para repos base.*
