...
| [ayunis-legal-mcp](https://github.com/ayunis-ai/ayunis-legal-mcp) (Alemania) | Bundesrecht.de + judicatura federal alemana; Gesetze-im-Internet API; verificación BGB/HGB/StGB; anti-hallucination de citas; **nuevo jul 2026** | MIT |
| [yargı-mcp](https://github.com/yargiai/yargi-mcp) (Turquía) | Yargıtay (Corte de Casación) + Danıştay + Anayasa Mahkemesi; 500k+ sentencias; búsqueda semántica turco/inglés; **nuevo jul 2026** | MIT |
| [taiwan-law-mcp](https://github.com/lawtech-tw/taiwan-law-mcp) (Taiwán) | Judicial Yuan database; 50+ códigos legales; texto chino/inglés; búsqueda semántica; **nuevo jul 2026** | MIT |

> **Señal v6**: La ola de MCPs jurisdiccionales se aceleró en julio 2026 — Alemania, Turquía y Taiwán siguieron el patrón Korean Law MCP. La carrera para construir PJe/CEJAT/SCJN/EJE (LATAM) como MCPs sigue abierta — first-mover captura el mercado de $4.8B.
...
---
*Actualizado automáticamente por el pipeline de ingest — v6 2026-07-14.*
