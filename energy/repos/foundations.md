...
## NEW in v3: Harvard SEAS Power-Agent Ecosystem

The **Power-Agent** GitHub organization (backed by Harvard SEAS Power and AI Initiative) is the new center of gravity for open-source LLM-powered power system tools. All repos under `github.com/Power-Agent` are MIT licensed.
...
| [ps-wiki/best-of-ps](https://github.com/ps-wiki/best-of-ps) | CC-BY | — | Weekly-updated ranked list of popular open-source libraries for power system analysis. Useful discovery tool. |
