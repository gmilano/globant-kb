...
> Lo más caliente en GitHub esta semana. Última actualización: 2026-07-14 (v5)
...
| FinGAIA | [SUFE-AIFLM-Lab/FinGAIA](https://github.com/SUFE-AIFLM-Lab/FinGAIA) | MIT | Benchmark 407-tareas para AI agents en finanzas (jul 2025, arXiv:2507.17186); SUFE + Fudan; dataset público parcial | 800 |
| **FinSight** | [RUC-NLPIR/FinSight](https://github.com/RUC-NLPIR/FinSight) | MIT | **ACL 2026 Main** — agente de deep research financiero que supera a OpenAI Deep Research (8.09 vs 6.11); pipeline multi-etapa con VLM chart refinement; MIT | ~800 |
| **BigFinanceBench** | [RogoAI/big-finance-benchmark](https://huggingface.co/datasets/RogoAI/big-finance-benchmark) | — | 928 tareas de research financiero, 36k puntos de rúbrica (arXiv:2606.03829, jun 2026); mejor agente: 58.8% — eval harness para Globant | — |
...
**Benchmarks como baseline**: usar FinGAIA (48.9%) + BigFinanceBench (58.8%) juntos en propuestas. FinGAIA es mejor para conocimiento financiero general; BigFinanceBench es más riguroso para flujos de research de analistas. Ambos fundamentan por qué los agentes necesitan fine-tuning, RAG y human-in-the-loop para producción regulada.

**TradingAgents v0.3.1 look-ahead fix**: evaluar cualquier repo de trading AI publicado antes de jul 2026 con el nuevo filtro. Los benchmarks anteriores al fix son sospechosos — oportunidad para re-evaluar soluciones de clientes.
