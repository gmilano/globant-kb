...
| **AI Berkshire** | **[xbtlin/ai-berkshire](https://github.com/xbtlin/ai-berkshire)** | **MIT** | **11.8k** | **NEW v7** — Value investing research framework for Claude Code / Codex: 4 masters' methodologies (Buffett, Munger, Duan Yongping, Li Lu) + multi-agent adversarial analysis. Skills: /investment-team /earnings-review /industry-research. Live returns: ¥1.46M+ over 2 years, outperforming all major global indices; Jun 27 2026 |
...
| FinRobot | [AI4Finance-Foundation/FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) | Apache-2.0 | 7k+ | Multi-agent equity research: Lead Agent orchestrates Data → Analysis → Modeling → Synthesis → Report → Bull/Bear/Judge pipeline execution engine |
...
| OpenFinClaw-CLI | [mirror29/openfinclaw-cli](https://github.com/mirror29/openfinclaw-cli) | MIT | 58+ | 60-second quant trading workflow agent: TypeScript 94.3%, MCP-native, 60+ built-in analysis capabilities (technical, fundamental, sentiment, risk, factor), 5 markets (US equities, A-shares, HK, crypto, FX), community strategy leaderboard |

## New Q3 2026 Agents

| Name | Repo | License | Stars | What's New |
|------|------|---------|-------|------------|
| **AI Berkshire** | [xbtlin/ai-berkshire](https://github.com/xbtlin/ai-berkshire) | MIT | 11.8k | **NEW v7** — Claude Code native value investing; 4-master adversarial debate; /investment-team /earnings-review /industry-research skills; ¥1.46M+ live returns |
