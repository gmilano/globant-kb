...
| **AI Berkshire** | MIT | [xbtlin/ai-berkshire](https://github.com/xbtlin/ai-berkshire) | 11.8k | **NEW v7** — Claude Code native value investing: 4-master methodology debate as slash commands; ¥1.46M+ live returns; drop-in for wealth management / family office workflows |

## Compliance & RegTech

| Platform | License | Repo | Use Case |
|----------|---------|------|---------|
| **Great Expectations** | Apache-2.0 | [great-expectations/great_expectations](https://github.com/great-expectations/great_expectations) | Data quality for financial pipelines; pair with AI agents to auto-detect anomalies in training data |
| **Apache Atlas** | Apache-2.0 | [apache/atlas](https://github.com/apache/atlas) | Data governance, lineage, classification; audit trail for EU AI Act Article 12 compliance (10-year log retention) |
| **FINOS OSERA** | Apache-2.0 | [ai.finos.org](https://ai.finos.org) | **NEW v7** — Governance-as-code: machine-readable EU AI Act + FCA Consumer Duty + PRA resilience compliance; DTCC + Morgan Stanley + RBC + NatWest; Jun 23, 2026 |
...
## Agent Payment Infrastructure (v7 Updated)
...
| **Amazon Bedrock AgentCore Payments** | Proprietary (AWS) | **NEW v7** — Managed x402 wallet for all Bedrock agents; launched May 7, 2026; AWS + Coinbase + Stripe; built-in spending controls + audit trail; 200ms settlement; 4 regions (US-East, US-West, EU-Frankfurt, APAC-Sydney) | ✅ Live May 7, 2026 (preview) |
...
└─────────────────┬───────────────┘
                  ...
                  ▼
┌─────────────────────────────────┐
│  Claude / Multi-Agent Stack     │  TradingAgents, AI Berkshire, FinRobot, ATLAS, FinRL
...
│  (compliance + audit trails)    │  EU AI Act / FCA / PRA / SEC model risk
└─────────────────────────────────┘
```
